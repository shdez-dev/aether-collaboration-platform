...
CREATE TABLE IF NOT EXISTS document_comments (
  ...
  created_by UUID NOT NULL,
  parent_id UUID, -- Para threading (respuestas a comentarios raíz)
  created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  ...
  -- ON DELETE CASCADE: al eliminar un comentario raíz, sus respuestas también se eliminan
...
-- Índice compuesto para listar comentarios abiertos de un documento (caso de uso más frecuente)
CREATE INDEX IF NOT EXISTS idx_document_comments_document_open
  ON document_comments(document_id, created_at ASC)
  WHERE resolved = FALSE;
-- Índice compuesto para listar threads raíz de un documento ordenados cronológicamente
...
-- Función y trigger para auto-actualizar updated_at en document_comments
...
-- ============================================================================
-- MILESTONE 5: SPRINTS E HITOS (GESTIÓN ÁGIL)
-- ============================================================================
...
-- Trigger updated_at para board_sprints
